...
export default function CreatePlaylistPage() {
  ...
  const [tracks, setTracks] = useState<Array<{ title: string; source: string; file?: File; url?: string }>>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-8">Créer une nouvelle playlist</h1>
